                    ...
                    <ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="quantity">
                                ...
                                <p class="text-center"><a href="#" wire:click.prevent="switchToSavedForLater('{{$item->rowId}}')">Save For Later</a></p>
                            </div>
                    ...
                    @if(!Session::has('coupon'))
                        <div class="checkout-info">
                            <label class="checkbox-field">
                                <input class="frm-input " name="have-code" id="have-code" value="" type="checkbox" wire:model="haveCouponCode"><span>I have
                                    promo code</span>
                            </label>
                            @if($haveCouponCode == 1)
                    ...
                    <ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
                           ...
                           {{--  <div class="price-field sub-total">
                            ...
                            <div class="delete">
                                <a href="#" class="btn btn-delete" title="Remove selected item" wire:click.prevent="deleteFromSaveForLater('{{ $item->rowId }}')">
