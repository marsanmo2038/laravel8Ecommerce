                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" wire:submit.prevent='updateCoupon'>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" placeholder="Category Code" class="form-control input-md" wire:model="code" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" placeholder="Category Value" class="form-control input-md" wire:model="value" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4" wire:ignore>
                                <input type="date" id="expiry-date" placeholder="Expiry Date" class="form-control datepicker" wire:model="expiry_date" />
